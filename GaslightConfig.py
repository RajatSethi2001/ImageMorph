...
def predict_wrapper(image, victim_data):
    ...
    image_output = list(victim(image_input).numpy()[0])
    return image_output
...
result_file = "Outputs/MNIST-Soft-Targeted.npy"
...
checkpoint_file = "Checkpoints/MNIST-Soft-Targeted.npy"
...
graph_file = "Figures/MNIST-Soft-Targeted.npy"
